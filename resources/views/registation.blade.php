...
<!-- Fonts -->
	...
	<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        <h1 class="hidden fixed top-0 right-0 px-6 py-4 sm:block"><a href="/">Back Page</a></h1>
        <h1 class="hidden fixed top-1% right-0 px-6 py-4 sm:block"><a href="{{ route('contact') }}">Next Page</a></h1>
